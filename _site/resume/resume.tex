...
\begin{achievements}
\item \textbf{Proficient:} Java, HTML, CSS, C, Racket, Android development, and XML
\item \textbf{Experienced:} Git, JavaScript, JSON, Jekyll, Markdown, and  \LaTeX\
\item \textbf{Familiar:} Bash, SSH, AngularJS, Python, Regex 
\item \textbf{Tools:} Linux(Ubuntu), Android Studio, Vim, Sublime Text, Atom, VirtualBox, Eclipse, TeXMaker
\item \textbf{Languages:} Native in Mandarin Chinese; Proficient in Japanese (JLPT N3 Level); Elementary knowledge in German and Norwegian
