...
\begin{achievements}
\item \textbf{Proficient:} Java, HTML, CSS, C, Racket, Markdown, Android development, and XML
\item \textbf{Experienced:} Bash, Git, JavaScript, JSON, Bootstrap, Jekyll, and  \LaTeX\
\item \textbf{Familiar:} AngularJS, R, SQL, Python 2.7, Regex, and C++
\item \textbf{Tools:} Linux(Ubuntu), Android Studio, Vim, Sublime Text, Atom, VirtualBox, Eclipse, TeXMaker
\item \textbf{Languages:} Native in Mandarin Chinese; Proficient in Japanese (JLPT N3 Level)
\item \textbf{Others:} Extensive knowledge in biology and biochemistry; Proficient in probability theory
\item Curious and conscientious with an earnest desire to learn; Fast independent worker with published projects; Effective team player (2 hackathons with team awards: WaterlooHacks and NHacks)
\end{achievements}
...
\employer{Personal Website \hspace{5pt} \Mundus~\href{http://dzed.me}{\underline{http://dzed.me}}}{November 2015-Present}{HTML, CSS, JavaScript, Jekyll, Bootstrap}
	...
	\item Accumulated over 500 page views as of May 2016
	\end{achievements}
...
\employer{Museum Educator Volunteer}{October 2014-June 2015}{University of British Columbia - Beaty Biodiversity Museum, Vancouver, BC}
	...
	\item Assisted with educational programs for children, including Puppet Show and Story Time 
	\end{achievements}

\header{Education}

\schoolwithcourses{Candidate for Bachelor of Computer Science, Honours, Co-operative}{2015-2020 (expected)}{University of Waterloo, Waterloo, Ontario \hspace{27pt} Cumulative Average: 88.1\% (3.89 GPA)}

\schoolwithcourses{Udacity - Introduction to Data Science}{May 2016}{}
...
\vspace{-2pt}
\hspace{8bp}
Valued at \$12,000 over 5 years; Awarded to top international applicants
...
\item \textbf{Other Interests} \hspace{3bp}languages(currently learning Japanese and Norwegian), piano(Grade 8), association football, tennis, baseball and football statistics, literature, and biology
\end{achievements}
