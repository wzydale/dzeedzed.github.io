...
\definition{$K_{m,n}$ denotes a \textbf{complete bipartite graph} on m and n vertices. A complete bipartite graph is a special kind of bipartite graph where every vertex of the first set is connected to every vertex of the second set. $V = \braces{x_1, x_2,..., x_m, y_1, y_2,..., y_n}$ $E = \braces{x_{i}y_{j}, \forall i | 1 \leq i \leq m, 1 \leq j \leq n }$} \\
