...
\begin{achievements}
\item \textbf{Proficient:} Java, HTML, CSS, C, Scheme (Racket), Android development, and XML
\item \textbf{Familiar:} Bash, SSH, JavaScript, AngularJS, Python, Git, Regex, JSON, Jekyll, Markdown, and  \LaTeX\
...
\employer{Personal Website \hspace{5pt} \Mundus~\href{http://dzed.me}{\underline{http://dzed.me}}}{November 2015-Present}{HTML, CSS, JavaScript, Jekyll, Bootstrap}
	...
	\item Cumulative page views over 500 as of May 2016
	\end{achievements}
